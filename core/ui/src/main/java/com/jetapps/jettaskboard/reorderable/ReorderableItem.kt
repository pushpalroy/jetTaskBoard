...
fun LazyItemScope.ReorderableItem(
  ...
  reorderableState, key, modifier, Modifier.animateItemPlacement(), orientationLocked, index,
  content
)
...
fun LazyGridItemScope.ReorderableItem(
  ...
  reorderableState, key, modifier, Modifier.animateItemPlacement(), false, index, content
)
